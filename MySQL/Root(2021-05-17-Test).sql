...
USE MYSQL;
-- 현재 접속한 Database(mysql)에 있는 모든 테이블을 보여달라
SHOW tables;
-- myDB라는 Database(데이터저장소) 생성
