...
VALUES('2021-05-18', '10:29:00', 'hooninfinity', 'hooninfinity@naver.com', '12345', '오늘은 화요일');
INSERT INTO tbl_guest_book(gb_date, gb_time, gb_writer, gb_email, gb_password, gb_content)
VALUES('2021-05-18', '10:29:00', 'hooninfinity', 'hooninfinity@naver.com', '12345', '노세노세 젊어서노세');
...
-- 가급적 PK를 기준으로 1개씩 처리하는 것이 좋다(UPDATE와 DELETE는 WHERE절이 따라다닌다!)
...
-- MySQL 고유함수로 문자열을 연결할때 CONCAT 함수 사용
...
-- 0 ~ 99까지의 임의의 정수 생성하고 그 수가 짝수인지 홀수인지 판별
SELECT
